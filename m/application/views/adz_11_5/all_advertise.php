...
<div class="search_var_all">
    <form class="form_new_content" method="post" action="<?= site_url('adz/all_advertise'); ?>">
        ...
        <span class="float_left">
            <b style="font-size: 12px;">Type &nbsp;</b><select style="width: 120px" class="select-style2 gender3 jtype_step3" name="type_id"><?= common::get_bike_type($t_id) ?></select>
        </span>
        <span class="float_left">
            <b style="font-size: 12px;">Make</b> &nbsp;<select style="width: 120px" class="select-style2 gender3 jmake_step3" id="j_make_data2" name="make_id"><?= common::get_bike_make_all($t_id, $make_id) ?></select>
        </span>
        <span class="float_left">
            <b style="font-size: 12px;">Model</b> &nbsp;<select style="width: 120px" class="select-style2 gender3 jmodel_step3" id="j_model_data3" name="model_id"><?= common::get_bike_model($t_id, $make_id) ?></select>
        </span>
