    ...
    <div style="width:100%;  margin: 10px 0">
        <div> 
            ...
            <?php if ($details_row['ad_type'] == 1) { ?>
                <img src="img/for_sale1.png" height="30"  style="vertical-align:middle;margin-top:-5px;"/>
            <?php }
            ?>
            <?php if ($details_row['ad_type'] == 2) { ?>
                <img src="img/for_wanted.png" width="80px" style="vertical-align:middle;margin-top:-5px;"/>
            <?php }
            ?>

            <h1 style="text-transform: uppercase; font-size: 16px; display: inline; margin-left: 5px; ">
                <?php
        ...
        <div style="background-color: #fff;margin:5px 0;"> 
            ...
            <span style="font-size:12px;color:gray; margin-left: 10px;"><img src="img/time.png" width="15" height="15"  style="vertical-align:top;"/>
                <?= date('F d Y', strtotime($details_row['bike_post_date'])); ?>
            </span>
            <span style="font-size:12px;color:gray; margin-left: 10px"><img src="img/people.png" width="15" height="15" style="vertical-align:top;" />
...
//
        ?>
<!--        <a style="margin-left:20px" href="sms:<?= $details_row[adz_user_phone] ?>;body=hi" <img src="img/sms.png" height="25"/></a>-->
        <?php
        //} else {
        //?>
<!--        <a style="margin-left:20px" href="sms:<?= $details_row[adz_user_phone] ?>?body=hello" >  <img src="img/sms.png" height="25"/></a>-->
        <?php
//}
        ?>
