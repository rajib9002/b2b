<div class="content_m">
    <form action='<?= $action ?>' method='post'  class="form_content_bike2biker">
        ...
        <select name="seller_type">
            <option value="1" <?php if ($session_array[seller_type] == '1' || $user_data[seller_type] == '1') echo 'selected';?>>
                Private
            </option>
            <option value="2" <?php if ($session_array[seller_type] == '2' || $user_data[seller_type] == '2') echo 'selected';?>>
                Trade
            </option>
        </select>
        ...
        <input class="select-style2" placeholder="Your Mobile" type="text" name="seller_phone" size="30" value="<?php echo (($session_array['seller_phone']) ? $session_array['seller_phone'] : $this->session->userdata('user_phone'));  ?>"/>
        <?=form_error('seller_phone', '<span>', '</span>') ?>
        <input class="select-style2" placeholder="Your Mobile 2" type="text" name="mobile_phone2" size="30" value="<?php echo (($session_array['mobile_phone2']) ? $session_array['mobile_phone2'] : $user_data[mobile_phone2]) ;?>"/>
        <input class="select-style2" placeholder="Land Phone" type="text" name="land_phone" size="30" value="<? echo (($session_array['land_phone']) ? $session_array['land_phone'] :  $user_data['land_phone']) ; ?>"/>
