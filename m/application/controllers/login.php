...
class login extends Controller {
    ...
    function index() {
        ...
        $data['dir'] = 'login';
        $data['page'] = 'index';
        $this->session->set_userdata('top_title', 'Login');
    ...
    function forgot_password() {
        ...
        if ($_POST['send']) {
            ...
            if ($this->form_validation->run()) {
                ...
                $this->session->set_flashdata('msg', '<div style="text-align:left;color:#000;margin-right:2px;font-size: 20px">Thank you for contacting Bike2Biker Online Account Support.<p>We have Sent you an email to ' . $_POST['email'] . ' .
    ...
    function account_activation($activation_key = '') {
        ...
        }else{$this->session->set_flashdata('msg', 'Activation Key is wrong!!');
        }
