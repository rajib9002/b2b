...
//    }
    ...
    function upload() {
        ...
        //$max_file_size = 1024000 * 1024000; // 250kb   // now is 10MB
        $valid_exts = array('jpeg', 'jpg', 'png', 'gif','JPEG', 'JPG', 'PNG', 'GIF');
        //  $sizes = array(350 => 350);//1000 => 1000,
        //if (isset($_FILES['file0'])) {
        ...
        if (in_array($ext, $valid_exts)) {
            ...
            $w=600;
            $h=400;
            $files[] = $this->mod_adz->resize($w, $h,$key);
            // }
             } //else {
           // $msg = 'Unsupported file';
            // }
            ...
            // $this->session->set_userdata('file0', "$name");
        }
