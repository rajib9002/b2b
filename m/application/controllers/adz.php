...
//    }
    ...
    function success() {
       ...
       // $this->session->unset_userdata('bike_insert_id');
        ...
        $data['dir'] = 'adz';
        $data['page'] = 'success';
        $this->load->view("login_with_success", $data);
    }
...
function delete_saved_adz($save_ad_id= '', $table_name = ''){
$user_id=$this->session->userdata('user_id');
if(user_id==''){
redirect('login');
}

sql::delete("save_ad","save_ad_id='$save_ad_id' and user_id='$user_id'");
redirect('adz/my_ads');
}
...
//    }
    ...
    function pic0() {
        if ($_POST) {
            define('UPLOAD_DIR', '../uploads/bike_image/');
            $img = $_POST['image'];
            ...
            $this->session->set_userdata('file0', "$filename");
      ...
      function pic1() {
        if ($_POST) {
            ...
            $file = UPLOAD_DIR . $filename;
            $success = file_put_contents($file, $data);
            $this->session->set_userdata('file1', "$filename");
            print $success ? $file : 'Unable to save the file.';
        }
    }
      function pic2() {
        if ($_POST) {
            ...
            $file = UPLOAD_DIR . $filename;
            $success = file_put_contents($file, $data);
            $this->session->set_userdata('file2', "$filename");
            print $success ? $file : 'Unable to save the file.';
        }
    }
      function pic3() {
        if ($_POST) {
            ...
            $file = UPLOAD_DIR . $filename;
            $success = file_put_contents($file, $data);
            $this->session->set_userdata('file3', "$filename");
            print $success ? $file : 'Unable to save the file.';
        }
    }
      function pic4() {
        if ($_POST) {
            ...
            $file = UPLOAD_DIR . $filename;
            $success = file_put_contents($file, $data);
            $this->session->set_userdata('file4', "$filename");
            print $success ? $file : 'Unable to save the file.';
        }
    }
      function pic5() {
        if ($_POST) {
            ...
            $file = UPLOAD_DIR . $filename;
            $success = file_put_contents($file, $data);
            $this->session->set_userdata('file5', "$filename");
            print $success ? $file : 'Unable to save the file.';
        }
    }
