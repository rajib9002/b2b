...
if (typeof jQuery !== 'undefined') {
    ...
    (function ($j) {
         ...
         */
        $j.fn.percentageLoader = function (params) {
            return this.each(function () {
                if (!$j.data(this, 'dj_percentageloader')) {
                    $j.data(this, 'dj_percentageloader', new PercentageLoader(this, params));
                } else {
                    var plugin = $j.data(this, 'dj_percentageloader');
