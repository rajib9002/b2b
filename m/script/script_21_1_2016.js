$j(document).ready(function(){
    ...
    $j("#pagination-div-id a").click(function(){
        $j.ajax({
            type: "POST",
            beforeSend: function() {
                $j('.loader').html("<div style='margin:0 auto;width:100px;height:40px;'><img style='margin:0 auto;width:36px;height:36px;' src='img/loading.gif'></div>");
            },
            url: $(this).attr("href"),
...
var common={
    init:function(){ 
        ...
        $j('#des').click(function(){
            ...
            window.location.href=base_url+'adz/all_advertise/'+ad_type+'/'+type_id+'/'+order_type+'/'+order_name+'/';
        });
