...
class ads extends Controller {
    ...
    function index($table_name = 'road_bikes') {
        ...
        if ($_POST['search']) {
            $gridObj->setGridOptions("Manage Ads", 880, 300, "bike_id", "desc", $gridColumn, $gridColumnModel, site_url('?c=ads&m=load_ads'.'&table_name=' . $table_name.'&type_id=' . $_POST['type_id'] . '&area_id=' . $_POST['area_id'] . '&make_id=' . $_POST['make_id'] . '&model_id=' . $_POST['model_id']), true);
        } else {
