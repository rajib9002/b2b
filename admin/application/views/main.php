...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="body_content">
                    ...
                    <div class="loginInfos">
                        ...
                        <div class="fl_right">
                            <?php if (common::is_logged_in()): ?>
                                You're logged in as <strong><?= $this->session->userdata('user_full_name') ?></strong>.
            ...
            <!-- /Header -->
            <?php            
                $full_access = $this->session->userdata('full_access');
                if($full_access==1) { include_once 'shared/header.php';}
                if($full_access==0) { include_once 'shared/limited_header.php';}  
            ?>
            <div class="content">
                <?php
