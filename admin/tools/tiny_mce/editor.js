tinyMCE.init({
    ...
    theme_advanced_fonts : "Andale Mono=andale mono,times;돌옴=돌옴,굴림;굴림=굴림,돋움,돋움체=돋움체,굴림,돋움;Arial=arial,helvetica,sans-serif;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;",
