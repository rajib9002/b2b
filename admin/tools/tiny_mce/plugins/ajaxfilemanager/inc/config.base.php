...
define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,pdf,doc,xls,ppt,swf,mp3,wmv,mpg,avi'); // 
...
define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,tif,html,htm,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf,doc,pdf,xls,ppt,mpg.avi');
