...
<div class="header_new">
    <div class="header_new_left float_left"><a href="<?= site_url('adz'); ?>"><img src="<?= base_url() ?>/uploads/welcome_right/<?php echo $lg['logo'] ?>"width="150px" height="25px"/></a></div>
    <div class="header_new_right float_right">
        ...
        <ul  class="header_menu" style="margin-top: 4px">           
            ...
            ?>
            <li><a title="Wanted Ads" href="<?= site_url('adz/index/2'); ?>" <?php if ($page == 'index' && $dir == 'adz' && $ad_type == '2') { ?> class="currentLink" <? } ?>>Wanted Ads</a></li>
            <li><a title="Sale Ads" href="<?= site_url('adz/index/1'); ?>" <?php if ($page == 'index' && $dir == 'adz' && $ad_type == '1') { ?> class="currentLink" <? } ?>>Sale Ads</a></li>
            <li><a title="All Ads" href="<?= site_url('adz/all_advertise'); ?>" <?php if ($page == 'all_advertise' && $dir == 'adz') { ?> class="currentLink" <? } ?>>All Ads</a></li>
            <li><a title="Home" href="<?= site_url('adz'); ?>" <?php if ($page == 'index' && $dir == 'adz' && $ad_type == 'all') { ?> class="currentLink" <? } ?> >Home</a></li>
