    ...
    <form action='<?= $action ?>' method='post'  class="form_content_bike2biker">
        ...
        <table class="rajib_table_content">
            ...
            <tr>
                ...
                <th>Email :*</th>
                <td><input class="select-style2" type="email" name="seller_email" size="30" value="<? echo (($_REQUEST['seller_email']) ? $_REQUEST['seller_email'] : $this->session->userdata('user_email'));  ?>"/>
                    <?= '<br/>' . form_error('seller_email', '<span>', '</span>') ?></td>
            </tr>
            <tr>
                <th>Your Name:*</th>
                <td><input class="select-style2" type="text" name="seller_name" size="30" value="<? echo (($_REQUEST['seller_name']) ? $_REQUEST['seller_name'] : $this->session->userdata('user_full_name'));  ?>"/> 
                    <?= '<br/>' . form_error('seller_name', '<span>', '</span>') ?></td>
            </tr>
            <tr>
                <th>Your Mobile:*</th>
                <td><input class="select-style2" type="text" name="seller_phone" size="30" value="<? echo (($_REQUEST['seller_phone']) ? $_REQUEST['seller_phone'] : $this->session->userdata('user_phone'));  ?>"/> 
