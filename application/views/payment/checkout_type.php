<!--<div class="paypal fl_left">
    <div class="p_header_bg"> </div>
    <?php if ($form_submitting == false) { ?>
        <form action="<?= site_url('payment/checkout') ?>" method="POST" id="valid_form">
            ...
            <?php } ?>
            <table width="100%"  style="padding:13px 37px 13px 13px;border-right:1px solid #eee;border-left:1px solid #eee;border-bottom: 1px solid #eee;">
                <tr>
                    <td valign="center">Amount:</td>
                </tr>
                <br/>
                <tr>
                    <td><input type='text' class="input_style number" name='amount' value="<?= $ad_price ?>" readonly="true"/></td>$  
                </tr>
                <br/>
                <tr>
                    <td align="left"><input type="submit" name="save" class="p_payment" value="Payment"></td>
                </tr>
            </table>
        </form>
    <?php } else {
...
<div class="payment_right fl_left">
    <div class="c_header_bg"></div>
    <?php
    session_unset();
        ...
        <form method="POST" action="<?= site_url('payment/checkout') ?>">
            ...
            <table width="100%" border="0" style="color:#000000;font-size: 11px;font-family: verdana;">
                ...
                <tr>
                    ...
                    <td align=left><br><input type=text class="input_style number" size=4 maxlength=7 name=amount value="<?= $ad_price ?>" readonly="true"> $</td>
                </tr>
                <tr>
                    <td/>
...
<? //$this->load->view("shared/ipg-util.php"); ?>

<?php
//// storing the SOAP message in a variable
//
...
<input type="hidden" name="txndatetime" value="<?php //echo common::getDateTime() ?>"/>
<input type="hidden" name="hash" value="<?php //echo common::createHash("13.00","978" ) ?>"/>
<input type="hidden" name="storename" value="13011606149"/>
...
<input type="hidden" name="timezone" value="GMT"/> 
 <input type="hidden" name="txndatetime" value="<?php //echo date("Y:m:d-H:i:s"); ?>"/> 
 <input type="hidden" name="hash" value="<?php //echo createHash("13","978" ); ?>"/> 
 <input type="hidden" name="storename" value="13205400069"/> 
<input type="hidden" name="mode" value="fullpay"/> 
<input type="text" name="chargetotal" value="13.00"/> 
<input type="hidden" name="currency" value="978"/> 

<input type="hidden" name="responseFailURL" value="http://bike2biker.com/home/sorry"/>

<input type="hidden" name="responseSuccessURL" value="http://bike2biker.com/home/success"/>
...
<input type="hidden" name="timezone" value="GMT"/> 
 <input type="hidden" name="txndatetime" value="<?php echo date("Y:m:d-H:i:s"); ?>"/> 
 <input type="hidden" name="hash" value="<?php echo createHash("$ad_price","978" ); ?>"/> 
 <input type="hidden" name="storename" value="13011606149"/> 
<input type="hidden" name="mode" value="fullpay"/> 
<input type="text" name="chargetotal" readonly="readonly" value="<?php echo $ad_price?>"/> 
<input type="hidden" name="currency" value="978"/> 
