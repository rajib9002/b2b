<div class='form_content'>
    ...
    <form id="form" action='<?= site_url($action); ?>' method='post'>
        ...
        ?>
        <h1>Sign-up form</h1><hr/><br/><br/>



        <table class="rajib_table_content" style="width:400px;float:left;">
            <tr>
        ...
        <table class="rajib_table_content" style="width:350px;float:left;">
        ...
        if ($adv_cost != '') {
            ?>
        <br/><br/>
            <input type="button"  style="" class="button" name="cancel" value="Previous Step" onclick='window.history.back();'/>
            <input type="submit"  style="float:right;" name="save" class="button" value="Next Step"/>
