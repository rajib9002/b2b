...
<div class="search_result margin-bottom_10">
    ...
    <?php
    $user_id = $this->session->userdata('user_id');
    $save_rows=sql::rows("save_ad","user_id='$user_id' and table_name!=''");
    ...
    if (count($save_rows) > 0):
        foreach ($save_rows as $s_row):
            ...
            <div class="p_box float_left" style="margin-top: 10px; height: 190px;">
                ...
                ?>
                <a href="<?php echo site_url('adz/details/' . $row[table_name] . '/' . $row['bike_id']); ?>"><img src="<?php echo base_url() . 'uploads/bike_image/t_' . $bike_image; ?>" alt="<?= $row['model_name'] ?>"  style="margin-top:10;width:162px; height:110px" /></a>
