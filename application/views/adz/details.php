...
<div style="text-align:left;">
    ...
    <div style="margin-bottom:5px;">
        ...
        if (common::is_logged_in()) {
            ...
            if ($is_exist > 0) {
                ?>
                <a style="float: right;margin-top: 10px;margin-right: 10px;" title="You already Saved this Adz" href="javascript:void(0);">
                    <img src='img/heart_fill.png'>
                </a>
            <?php } else { ?>
                <a  style="float: right;margin-top: 10px;margin-right: 10px;" title="Save Adz" href="<?php echo site_url('adz/save_adz/' . $details_row['table_name'] . '/' . $details_row['bike_id']) ?>">
                    <img src='img/heart_blank.png'>
                </a>
            <?php } ?>
        <?php } else { ?>
            <a  style="float: right;margin-top: 10px;margin-right: 10px;" title="Save Adz" href="<?php echo site_url('login') ?>">
                <img src='img/heart_blank.png'>
            </a>
        <?php } ?>
...
<style>
#show a span.t_e{display:block;}
span.t_em{width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}

#show a span.t_em{display:none;}
#show a:hover span.t_e{display:none;}
#show a:hover span.t_em{display:block;}
</style>


                <span style="float:left;cursor:pointer;" onmouseout="hidep()"> <img src="img/telephone_icon.png" width="35px" style="margin-left:20px; position: absolute;"> <p  id="hidePhone"  style="display: none;color:#fff; font-size: 19px; float: left ; margin-left: 60px; margin-top: 6px;"><?php echo $details_row['adz_user_phone']; ?></p></span>
                <p id="showPhone" onmouseover="showp()" title="Click to Show Number" style="cursor:pointer;color:#fff; font-size: 20px; margin-left: 60px;"><?php echo 'Show Phone No'; ?> </p>
                <div class="clear"></div>
                <span id="show"> <img src="img/email_icon.png" width="35px" style="margin-left:20px; float: left; margin-right: 10px;"> <a href="<?= site_url('adz/details/' . $t_name . '/' . $details_row['bike_id']) ?>#mail"   style="color:#fff; font-size: 20px; float: left; margin: 0; padding: 0;"><span class="t_e" title="Click to Reply">Reply By Email</span><span class="t_em" title="<?php echo $details_row['adz_user_email'] ?>"><?php echo $details_row['adz_user_email'] ?></span></a></span>
            </div>
...
//echo $details_row[type_id];
    $related_items = sql::rows("$t_name", "type_id='$details_row[type_id]' and bike_status=1 and bike_id!='$details_row[bike_id]' order by RAND() limit 0,4");
