        ...
        <div class='form_content' style="width:100%;">
            ...
            <table class="rajib_table_content" style="width:45%;float:left;">
                ...
                <tr>
                    ...
                    <td>
                        <select class="select-style2 gender2 jcountry jload_area2" name="country_id" style="width: 200px"><?= common::get_country_options($session_array['country_id']) ?></select>
                        <div class="clear"></div>
                ...
                <tr>
                    ...
                    <td>
                        <select class="select-style2 gender2 jarea" id="j_area_data2" name="area_id" style="width: 200px">
                            <?php if($session_array['area_id']!='') {
                                echo common::get_area_respect_with_country($session_array['country_id'],$session_array['area_id']);
                            }?>
                        </select>
                        <div class="clear"></div>
                ...
                <tr>
                    ...
                    <td><input class="select-style2" type="text" name="post_code" size="30" style="width: 200px" value="<?= $session_array['post_code'] ?>"/> </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="price" size="30" class="select-style2 " style="width: 200px" value="<?= $session_array['price'] ?>"/>
                        <div class="clear"></div>
            ...
            <table class="rajib_table_content" style="width:55%;float:left;">
                ...
                <tr>  
                    <td>
                        <!--class="jqte-test"-->
                        <textarea style="width:440px;height:178px;"  name="full_description"><?= $session_array['full_description'] ?></textarea>
                        <div class="clear"></div>
