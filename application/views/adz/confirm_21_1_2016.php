                    ...
                    <ul class="thums_style">
                        ...
                        for ($i = 0; $i < 5; $i++) {
                            ...
                            if ($file != '') {
                                ...
                                ?>
                                <li><a><img class="element isotope-item"    src="<?php echo base_url() ?>uploads/bike_image/t_<?php echo $file ?>" data-zoom="<?php echo base_url() ?>uploads/bike_image/l_<?php echo $file ?>" height="70px" width="90px" /></a></li>
                                <?php
                            }
                            //$i++;
                            //if ($i > 5)
