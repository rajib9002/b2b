...
<!--            <p style="font-size: 18px; margin: 0; padding: 5px;">Select Main Type</p>-->
            ...
            <p><input type="radio" name="ad_type" value="1" <?php if ($session_array['ad_type'] == '1' || $session_array['ad_type'] == '') { ?> checked="checked" <?php } ?>/> For Sale( You have something to sell)</p>

            <p><input type="radio" name="ad_type" value="2" <?php if ($session_array['ad_type'] == '2') { ?> checked="checked" <?php } ?>/> Wanted( You are looking for something to buy)</p>
            <?= form_error('ad_type', '<span>', '</span>') ?>

            <br/>
            <br/>
            <p style="color:white ; font-size: 18px; margin: 0; padding: 5px;">Type of seller</p>
            <p><input type="radio" name="seller_type" value="1" <?php if ($session_array['seller_type'] == '1' || $session_array['seller_type'] == '') { ?> checked="checked" <?php } ?>/>Private</p>
            <p> <input type="radio" name="seller_type" value="2" <?php if ($session_array['seller_type'] == '2') { ?> checked="checked" <?php } ?>/>Trade</p>
        </div>
        ...
        <div class="step2_right" style="width: 350px; float: left; margin-left: 50px">
            ...
            <textarea name="ad_title" rows="1" cols="50" style="padding: 10px" id="textarea" maxlength="20" ><?= $session_array['ad_title'] ?></textarea>
