...
//            ?>
        ...
        <span class="save_button">
            <a href="<?php echo site_url('adz/save_adz/' . $details_row['bike_id']) ?>">Save Ads</a>
        </span>
    ...
    <div>
        <div style="float:left;margin:0;padding:0;">
            ...
            <style>
                ...
                .thums_style li{ list-style-type: none; width: 88px; border: 1px solid bisque; float: left;}
            ...
            <div id="thumbs">
                <ul class="thums_style">
                    ...
                    foreach ($imgages as $img) {
                        ?>
                        <li><a><img class="element isotope-item"    src="<?php echo base_url() ?>uploads/bike_image/t_<?php echo $img['bike_image'] ?>" data-zoom="<?php echo base_url() ?>uploads/bike_image/large/<?php echo $img['bike_image'] ?>" height="70px" width="90px" /></a></li>
...
<a name="mail">
    <form id="mail_form" style="display:none;background-color:#376388; width: 450px;" action="<?= site_url("home/reply/" . $details_row['bike_id']) ?>" method="post">
